...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/kamisama/Programming/INF Senior Project/OrderlyAI/services/api/public/storage' => 'string',
            ...
            'products.import.max_rows' => 'integer',
            'products.import.max_file_kb' => 'integer',
...
'reports.view','dashboard.view','reports.orders.view','reports.inventory.view','reports.returns.view',
'products.import','products.export','users.manage','roles.manage','sameOrg',
'viewAny','view','create','update','delete',
'confirm','readyToShip','cancel','hasPermission','archive',
'markDelivered','markReturned','markUnpaid','addItem','restock',
'createMovement',);
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/kamisama/Programming/INF Senior Project/OrderlyAI/services/api/public/storage','logging.default',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','products.import.max_rows','products.import.max_file_kb',
...
'boost.executable_paths.composer','boost.executable_paths.npm','boost.executable_paths.vendor_bin','mcp.redirect_domains','excel.exports.chunk_size',
...
'SESSION_DRIVER','SESSION_LIFETIME','SESSION_EXPIRE_ON_CLOSE','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_DOMAIN','SESSION_COOKIE','SANCTUM_STATEFUL_DOMAINS','BROADCAST_CONNECTION','FILESYSTEM_DISK',
