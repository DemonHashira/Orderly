...
import type { InventoryMovementsTableRow } from '@/features/inventory/ui/inventory-movements-table-columns'
import { buildInventoryMovementsTableColumns } from '@/features/inventory/ui/inventory-movements-table-columns'

const props = defineProps<{
  rows: InventoryMovementsTableRow[]
  currentPage: number
  totalPages: number
  totalRows: number
  perPage: number
...
const columns = computed(() => buildInventoryMovementsTableColumns())
