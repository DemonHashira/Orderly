...
import type { InventoryStocksTableRow } from '@/features/inventory/ui/inventory-stocks-table-columns'
import { buildInventoryStocksTableColumns } from '@/features/inventory/ui/inventory-stocks-table-columns'

const props = defineProps<{
  rows: InventoryStocksTableRow[]
  currentPage: number
  totalPages: number
  totalRows: number
  perPage: number
...
const emit = defineEmits<{
  (e: 'open-movements', productId: number): void
...
const columns = computed(() =>
  buildInventoryStocksTableColumns({
    onOpenMovements: (id) => emit('open-movements', id),
  }),
)
